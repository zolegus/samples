...
//    }
//
//    protected static Chronicle getVanillaChronicle(String type, String id) throws IOException {
//        return ChronicleQueueBuilder.VanillaChronicleQueueBuilder.vanilla(basePath(type, id)).build();
...
//    }
//
//    public static void readSimple() throws IOException {
//        Chronicle chronicle = ChronicleQueueBuilder.VanillaChronicleQueueBuilder.vanilla("./logs/main").build();
...
//    }
//
//    public static void readTracer() throws IOException {
////        Chronicle chronicle = new VanillaChronicle("./logs/text_logger");
//        Chronicle chronicle = ChronicleQueueBuilder.VanillaChronicleQueueBuilder.vanilla("./logs/text_logger").build();
//        ExcerptTailer tailer = null;
//        try {
//            tailer = chronicle.createTailer().toStart();
//        } catch (IOException e) {
